...
const BTN_RUNDENSTART = {w: 186, h: 91, pfad: './img/btn_rundenstart.png'};
const SPIELER_TOT = {pfad: './img/spieler_tot.png'}
const COUNTDOWN = {
    intervall: 100, 
...
const KOLLISIONSKREIS = {w: 61, h: 120, pfad: './img/kollisionskreis.png'};
const ABSTAND_RAND = 50;
const WAND = {h: 30, w: 30, nMax: 10, pfad: './img/wand.png'};
